...
<template>
    <div id="about-container" class="relative animations w-full h-full opacity-90 pt-28 flex flex-col justify-center items-center overflow-x-hidden">
        <div class="w-full text-center lg:text-left">
            <span class="text-5xl font-bold inline"><p class="hidden md:inline">—</p> Ab</span>
            ...
            <div class="flex flex-col">
                ...
                <div class="flex flex-row gap-1 mt-6">
                    <a href="mailto:hello@VannyFasanelli.com" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="icon bi bi-envelope" viewBox="0 0 16 16">
                            <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1zm13 2.383-4.708 2.825L15 11.105zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741M1 11.105l4.708-2.897L1 5.383z"/>
                        </svg>
                    </a>

                    <a href="https://it.linkedin.com/in/vanny-fasanelli-3428b218a" target="_blank">
                    ...
                    <a href="https://github.com/VannyFasanix" target="_blank">
                    ...
                    <a href="https://www.instagram.com/vanny.fasanelli/" target="_blank">
